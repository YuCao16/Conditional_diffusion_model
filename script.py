    ...
    for ep in range(n_epoch):
        ...
        with torch.no_grad():
            ...
            for _, w in enumerate(ws_test):
                ...
                save_image(grid, f"{save_dir}image_ep{ep}_w{w}.png")
                print(f"saved image at {save_dir}" + f"image_ep{ep}_w{w}.png")
                ...
                if ep % 5 == 0 or ep == int(n_epoch - 1):
                    ...
                    def animate_diff(i: int, x_gen_store: np.ndarray) -> List:
                        print(
                    ...
                    ani.save(
                        f"{save_dir}gif_ep{ep}_w{w}.gif",
                        dpi=100,
                        writer=PillowWriter(fps=5),
                    )
                    print(f"saved image at {save_dir}" + f"gif_ep{ep}_w{w}.gif")
